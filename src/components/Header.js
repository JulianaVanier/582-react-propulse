      ...
      <Container>
        <Navbar.Brand href="#">
          <Image
            ...
            src="/assets/image/propulse-sportswear-high-resolution-logo-black-on-transparent-background.png"
          />
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <NavDropdown title="Kids" id="navbarScrollingDropdown">
              ...
              <NavDropdown.Item href="#action4">New Arrivals</NavDropdown.Item>
              <NavDropdown.Divider />
